...
void BehaviorViewer::initializeGui()
{
	...
	//TwAddVarRW(m_TwBehaviorBar, "InitialSpeed", TW_TYPE_DOUBLE, &BehaviorController::m_ve)
	TwAddButton(m_TwBehaviorBar, "Reset", onResetCb, this, "");


	//TODO: Add your code here to create additional GUI Variables
	TwAddVarRW(m_TwBehaviorBar, "VelKv", TW_TYPE_INT32, &BehaviorController::gVelKv, "");
	TwAddVarRW(m_TwBehaviorBar, "OriKv", TW_TYPE_INT32, &BehaviorController::gOriKv, "");
	TwAddVarRW(m_TwBehaviorBar, "OriKp", TW_TYPE_INT32, &BehaviorController::gOriKp, "");
}
